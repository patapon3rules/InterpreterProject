...
//template that initializes a generic class called error to be constructed whenever an error has to be invoked
template<int N>
    class Error
    {
        public:
...
Lexer::Lexer(std::istream* ps) : p_input{ps}, owns_input{false}
{
    init();
}
